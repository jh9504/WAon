...
public class RingAlarmActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        curWeather = (ImageView)findViewById(R.id.weatherImage);
            ...
            if(W == null)
                ...
                switch (W) {
                    case "Cloudy": case "Little_Cloudy":
                        ...
                        back.setBackgroundColor(Color.parseColor("FFA6EDE1"));
                        break;
                    case "Sunny":
                        curWeather.setImageResource(R.drawable.weather_sunny);
                        back.setBackgroundColor(Color.parseColor("FFFB9C97"));
                        break;
                    case "Rainy":
                        curWeather.setImageResource(R.drawable.weather_rainy);
                        back.setBackgroundColor(Color.parseColor("FF7F97FF"));
                        break;
                    case "Snowy":
                        curWeather.setImageResource(R.drawable.weather_snow);
                        back.setBackgroundColor(Color.parseColor("FFEEFBF8"));
                        break;
                    case "Default":
                        curWeather.setImageResource(R.drawable.waon_logo);
                        back.setBackgroundColor(Color.parseColor("FFF6EBDC"));
                        break;
                }
            }
        }
